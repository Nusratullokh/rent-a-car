...
const CardComponent = ({car} : {car: Car}) => {
  return (
  <div className='card w-[300px] rounded-lg bg-[white] '>
    <div className="title-like flex items-center justify-between">
        ...
        <button className='like'>
             ...
             <AiOutlineHeart  className="text-[red] text-[25px]"/> 
    ...
    <div className="flex items-center w-full justify-between mt-2 ">
        ...
        <button className=" flex items-center justify-center px-5 py-1.5 rounded-lg bg-[dodgerblue] text-white">Rent Now</button>
    </div>
  </div>
